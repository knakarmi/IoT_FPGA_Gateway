...
entity gcm_gctr is
    generic(
        gctr_mode_g                 : std_logic_vector(1 downto 0)  := "00";
        gctr_n_rounds_g             : natural range 0 to 14   := 10);
    port(
        rst_i                       : in  std_logic;
        clk_i                       : in  std_logic;
        gctr_mode_i                 : in  std_logic_vector(1 downto 0);
        gctr_key_word_val_i         : in  std_logic_vector(3 downto 0);
        gctr_key_word_i             : in  std_logic_vector(256-1 downto 0);
        gctr_iv_val_i               : in  std_logic;
        gctr_iv_i                   : in  std_logic_vector(96-1 downto 0);
        gctr_icb_start_cnt_i        : in  std_logic;
        gctr_icb_stop_cnt_i         : in  std_logic;
        gctr_pipe_reset_i           : in  std_logic;
        gctr_data_in_bval_i         : in  std_logic_vector(16-1 downto 0);
        gctr_data_in_i              : in  std_logic_vector(128-1 downto 0);
        ghash_h_loaded_i            : in  std_logic;
        ghash_j0_loaded_i           : in  std_logic;
        aes_ecb_val_o               : out std_logic;
        aes_ecb_data_o              : out std_logic_vector(128-1 downto 0);
        gctr_ready_o                : out std_logic;
        gctr_data_out_val_o         : out std_logic;
        gctr_data_out_bval_o        : out std_logic_vector(16-1 downto 0);
        gctr_data_out_o             : out std_logic_vector(128-1 downto 0);
...
architecture arch_gcm_gctr of gcm_gctr is
    ...
    signal icb_iv                   : std_logic_vector(128-1 downto 0);
    signal gctr_data_in_val         : std_logic;
    signal gctr_data_in             : std_logic_vector(128-1 downto 0);
    signal aes_ecb_busy             : std_logic;
    signal aes_ecb_val              : std_logic;
    signal aes_ecb_data             : std_logic_vector(128-1 downto 0);
    signal gctr_data_out_val        : std_logic;
    signal gctr_data_out_val_q      : std_logic;
    signal gctr_data_out_bval       : std_logic_vector(16-1 downto 0);
    signal gctr_data_out_bval_q     : std_logic_vector(16-1 downto 0);
    signal gctr_data_out            : std_logic_vector(128-1 downto 0);
    signal gctr_data_out_q          : std_logic_vector(128-1 downto 0);
    ...
    component aes_ecb is
        generic(
            aes_n_rounds_g              : natural range 0 to 14   := 10
        );
        port(
            rst_i                       : in  std_logic;
            clk_i                       : in  std_logic;
            ...
            aes_key_word_i              : in  std_logic_vector(256-1 downto 0);
            aes_pipe_reset_i            : in  std_logic;
            aes_plain_text_val_i        : in  std_logic;
            aes_plain_text_i            : in  std_logic_vector(128-1 downto 0);
            aes_cipher_text_ack_i       : in  std_logic;
            aes_cipher_text_val_o       : out std_logic;
            aes_cipher_text_o           : out std_logic_vector(128-1 downto 0);
    ...
    component aes_icb is
        port(
            ...
            icb_iv_i                    : in  std_logic_vector(96-1 downto 0);
            aes_ecb_busy_i              : in  std_logic;
            icb_val_o                   : out std_logic;
            icb_iv_o                    : out std_logic_vector(128-1 downto 0);
