...
entity gcm_ghash is
    ...
    port(
        ...
        aes_ecb_data_i              : in  std_logic_vector(128-1 downto 0);
        ghash_aad_val_i             : in  std_logic;
        ghash_aad_bval_i            : in  std_logic_vector(16-1 downto 0);
        ghash_aad_i                 : in  std_logic_vector(128-1 downto 0);
        ghash_ct_val_i              : in  std_logic;
        ghash_ct_bval_i             : in  std_logic_vector(16-1 downto 0);
        ghash_ct_i                  : in  std_logic_vector(128-1 downto 0);
        ghash_h_loaded_o            : out std_logic;
        ghash_j0_loaded_o           : out std_logic;
        ghash_tag_val_o             : out std_logic;
        ghash_tag_o                 : out std_logic_vector(128-1 downto 0));
end entity;
...
architecture arch_gcm_ghash of gcm_ghash is
    ...
    --! Signals
    signal h_q                  : std_logic_vector(128-1 downto 0);
    signal J0_q                 : std_logic_vector(128-1 downto 0);
    signal gf_x                 : std_logic_vector(128-1 downto 0);
    signal gf_y                 : std_logic_vector(128-1 downto 0);
    signal gf_y_whole           : std_logic_vector(128-1 downto 0);
    signal y_q                  : std_logic_vector(128-1 downto 0);
    ...
    signal aad_cnt_q            : std_logic_vector((128 / 2 - 3)-1 downto 0);
    signal aad_cnt_en           : std_logic;

    signal y_init               : std_logic;
    signal y_init_q             : std_logic;
    signal ct_val               : std_logic;
    signal ct_cnt_q             : std_logic_vector((128 / 2 - 3)-1 downto 0);
    signal ct_cnt_en            : std_logic;

    signal bval_len             : natural range 0 to 16;
    signal bval_cnt             : std_logic_vector((128 / 2 - 3)-1 downto 0);
    signal cnt_sel              : std_logic_vector((128 / 2 - 3)-1 downto 0);
    signal bval_val             : std_logic;
    signal bval_sel             : std_logic_vector(16-1 downto 0);
    signal data_val             : std_logic;

    signal ghash_data_masked    : std_logic_vector(128-1 downto 0);
    signal ghash_data_mask      : std_logic_vector(128-1 downto 0);
    signal ghash_data_sel       : std_logic_vector(128-1 downto 0);
    signal bit_cnt              : std_logic_vector(128-1 downto 0);
    signal x_data               : std_logic_vector(128-1 downto 0);
    signal y_prev               : std_logic_vector(128-1 downto 0);
    signal j0_val_q             : std_logic;
    signal cnt_val_q            : std_logic;
    signal ghash_tag_val_q      : std_logic;
    signal ghash_tag            : std_logic_vector(128-1 downto 0);
    signal ghash_tag_q          : std_logic_vector(128-1 downto 0);

    signal x_part_0             : std_logic_vector(128-1 downto 0);
    signal x_part_1             : std_logic_vector(128-1 downto 0);
    signal y_part_0             : std_logic_vector(128-1 downto 0);
    signal y_part_1             : std_logic_vector(128-1 downto 0);
    signal y_part               : std_logic_vector(128-1 downto 0);
    ...
    component ghash_gfmul is
        port(
            gf_mult_h_i         : in  std_logic_vector(128-1 downto 0);
            gf_mult_x_i         : in  std_logic_vector(128-1 downto 0);
            gf_mult_y_o         : out std_logic_vector(128-1 downto 0)
        );
    end component;
