...
architecture arch_ghash_gfmul of ghash_gfmul is
    ...
    --! Types
    type gf_array_t is array ((128-1) downto 0) of std_logic_vector(128-1 downto 0);

    --! Signals
    signal gf_z : std_logic_vector(128-1 downto 0);
...
begin
    ...
    gf_mult_p   : process(gf_mult_x_i, gf_mult_h_i)
        variable tmp_v : std_logic_vector(128-1 downto 0);
        variable vec_v : std_logic_vector(128-1 downto 0);
        variable acc_v : gf_array_t;
    begin
        tmp_v := gf_mult_h_i;

        for i in 128-1 downto 0 loop
            --! Save tmp_v vertically in the array
            for j in 128-1 downto 0 loop
