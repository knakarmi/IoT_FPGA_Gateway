...
/* Definitions for peripheral AXI_GPIO_CTRL */
#define XPAR_AXI_GPIO_CTRL_BASEADDR 0x41200000
#define XPAR_AXI_GPIO_CTRL_HIGHADDR 0x4120FFFF
#define XPAR_AXI_GPIO_CTRL_DEVICE_ID 0
#define XPAR_AXI_GPIO_CTRL_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_CTRL_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_KEY_VAL */
#define XPAR_AXI_GPIO_KEY_VAL_BASEADDR 0x41210000
#define XPAR_AXI_GPIO_KEY_VAL_HIGHADDR 0x4121FFFF
#define XPAR_AXI_GPIO_KEY_VAL_DEVICE_ID 1
#define XPAR_AXI_GPIO_KEY_VAL_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_KEY_VAL_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_STATUS */
#define XPAR_AXI_GPIO_STATUS_BASEADDR 0x41220000
#define XPAR_AXI_GPIO_STATUS_HIGHADDR 0x4122FFFF
#define XPAR_AXI_GPIO_STATUS_DEVICE_ID 2
#define XPAR_AXI_GPIO_STATUS_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_STATUS_IS_DUAL 0


/******************************************************************/

/* Canonical definitions for peripheral AXI_GPIO_CTRL */
#define XPAR_GPIO_0_BASEADDR 0x41200000
#define XPAR_GPIO_0_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXI_GPIO_CTRL_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 0

/* Canonical definitions for peripheral AXI_GPIO_KEY_VAL */
#define XPAR_GPIO_1_BASEADDR 0x41210000
#define XPAR_GPIO_1_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_AXI_GPIO_KEY_VAL_DEVICE_ID
#define XPAR_GPIO_1_INTERRUPT_PRESENT 0
#define XPAR_GPIO_1_IS_DUAL 0

/* Canonical definitions for peripheral AXI_GPIO_STATUS */
#define XPAR_GPIO_2_BASEADDR 0x41220000
#define XPAR_GPIO_2_HIGHADDR 0x4122FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_AXI_GPIO_STATUS_DEVICE_ID
